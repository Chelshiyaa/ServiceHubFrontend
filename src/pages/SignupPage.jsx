...
    
    try {
      const res = await axios.post(`${API_BASE}/api/auth/register`, { name, email, password, role: 'customer' });
      
      localStorage.setItem("token", res.data.token);
      onSignupSuccess(res.data); // Call the success handler from App.jsx
      
      alert("Sign-up successful!"); // Pop-up message
